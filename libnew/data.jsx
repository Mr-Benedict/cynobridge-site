...
const ACTIVITY = [
  { id: 1, type: "kill", icon: "target", text: "Destroyed Caracal in Perimeter", time: "14m", color: C.green },
  { id: 2, type: "trade", icon: "wallet", text: "Sold 2,000× Tritanium @ 5.82 ISK", time: "1h", color: C.amber },
  { id: 3, type: "skill", icon: "cpu", text: "Caldari Cruiser V completed", time: "3h", color: C.cyan },
  { id: 4, type: "mail", icon: "activity", text: "Mail from Haruki Sato-Ramen", time: "5h", color: C.fg },
  { id: 5, type: "market", icon: "bars", text: "Buy order filled: 50× Tengu Core", time: "8h", color: C.amber },
];
